class DropBoxController{
  ...
  //!CONNEXÃO COM BANCO DE DADOS FIREBASE
  connectFirebase(){
    // Your web app's Firebase configuration
    var firebaseConfig = {
      apiKey: "AIzaSyBLA9IASgV7GU3-QnkWccqzxMnv04Q89r4",
      authDomain: "eobox-5a096.firebaseapp.com",
      databaseURL: "https://eobox-5a096.firebaseio.com",
      projectId: "eobox-5a096",
      storageBucket: "eobox-5a096.appspot.com",
      messagingSenderId: "524494866014",
      appId: "1:524494866014:web:0fcdc753c5826dccfcd6cf",
      measurementId: "G-1WN5V0F4RG"
    };
    // Initialize Firebase
  ...
  initEvents(){
    ...
    this.buttonDeleteFileElement.addEventListener('click', ()=> {
      this.removeTaskFile().then(responses=> {
  ...
  //TRATA OS DADOS DOS ARQUIVOS PARA O FIREBASE
  getFirebaseRef(){
  ...
  //*PARA CADA ARQUIVO UM ICONE QUE O REPRESENTE
